          ...
          >
            ...
            <form className="space-y-4 md:space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2 text-[10px] font-bold uppercase tracking-wide px-2">
                   ...
                   <div className={`flex items-center gap-2 transition-colors duration-300 ${
                      passwordsMatch === true ? "text-green-500" : 
                      passwordsMatch === false ? "text-red-500" : "text-slate-400"
                   }`}>
                      {passwordsMatch === true ? <Check size={12} /> : 
                       passwordsMatch === false ? <X size={12} /> : 
              ...
              <button 
                ...
                className={`relative w-full h-12 rounded-full font-bold uppercase tracking-wider overflow-hidden transition-all mt-4 group
                  ${isFormValid 
                    ? "bg-transparent border-2 border-[#FF6B00] text-[#FF6B00] dark:text-white hover:text-white cursor-pointer" 
                    : "bg-slate-100 dark:bg-white/10 text-slate-400 border-none cursor-not-allowed"
                  }
                `}
              >
        ...
        <div className="relative z-10 max-w-lg">
           ...
           <div className="flex gap-8 border-t border-white/10 pt-8">
              ...
              <div>
                 ...
                 <p className="text-xs text-white/50 uppercase tracking-widest font-bold">Partner Eateries</p>
              </div>
           </div>
        </div>
      </div>
...
function PasswordInputGroup({ label, name, onChange, isValid, showValidation = false }) {
  ...
  return (
    <div className="relative group">
      <div className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${showValidation && isValid === false ? "text-red-500" : "text-slate-400 group-focus-within:text-[#FF6B00]"}`}>
        <Lock size={18} />
      </div>
