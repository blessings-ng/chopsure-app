...
export default function TopUpForm() {
  ...
  const completeInjection = async (reference) => {
    ...
    try {
      ...
      // 2. Logic: Update if exists, Insert if new.
      if (wallet) {
      ...
      // 3. Log the transaction - Back to original structure
        ...
        <div className="w-full max-w-md text-center">
          <div className="mb-8 dark:text-white">
            <input 
               ...
               className="w-full bg-transparent text-center text-7xl font-black italic tracking-tighter outline-none border-b border-slate-200 dark:border-white/10 pb-2"
            />
            <p className="text-[9px] font-black uppercase tracking-widest text-slate-400 mt-2 italic">Top Up Amount</p>
          </div>
